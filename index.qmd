...
## Question 3 {.smaller .noincremental}
...
- L'objectif de l'apprentissage: détecter des régularités statistiques fines
    ...
    - Modèles plus ou moins complexes selon le type de tâche: _machine learning_ -> réseaux de neurones
...
- L'apprentissage est porteur de promesse
